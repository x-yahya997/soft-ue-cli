...
from soft_ue_cli.testimonial import cmd_submit_testimonial, _build_issue_body


def test_build_issue_body_full():
...
def test_build_issue_body_minimal():
    body = _build_issue_body(
        message="Nice",
        agent_name=None,
        rating=None,
...
def test_build_issue_body_rating_stars():
    body = _build_issue_body(
